...
public class AppFundRequirement extends BaseTest {
	...
	public void oderConfrim() throws Exception {
		...
		new WebDriverWait(driverweb, 30).until(ExpectedConditions.elementToBeClickable(By.className("btn-submit")))
				.click();
		...
		new WebDriverWait(driverweb, 30).until(ExpectedConditions.elementToBeClickable(By.name("operation_info")))
				.sendKeys("123456");
		new WebDriverWait(driverweb, 30)
